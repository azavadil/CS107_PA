...
class imdb {
 ...
 private:
  ...
  struct ActorSearchPair { 
    const void *actorFilePtr; 
    const char *playerName;
  };

  struct MovieSearchPair { 
    const void *movieFilePtr; 
    const film *targetFilm; 
  };
  ...
  static int nameCmp(const void* vp1, const void* vp2); 
  static int movieCmp(const void* vp1, const void* vp2);
